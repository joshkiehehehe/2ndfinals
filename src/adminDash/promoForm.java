...
public class promoForm extends javax.swing.JFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT p_id, p_name, p_status FROM tbl_promos");
    ...
    private void initComponents() {
        ...
        Update.setBackground(new java.awt.Color(99, 74, 49));
        ...
        addLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        addLabel2.setForeground(new java.awt.Color(255, 255, 255));
        addLabel2.setText("UPDATE");
        Update.add(addLabel2);
        addLabel2.setBounds(4, 0, 60, 17);

        delete.setBackground(new java.awt.Color(99, 74, 49));
        ...
        pstat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Available", "Unattainable", " " }));
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(pid, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addComponent(select)
                        .addGap(71, 71, 71)
        ...
        jLabel3.setText("PROMO FORM");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/back.png"))); // NOI18N
    ...
    private void pTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pTableMouseClicked
        ...
        if(rowIndex < 0){
            ...
            try{
                ...
                ResultSet rs = dbc.getData("SELECT * FROM tbl_promos WHERE p_id = '"+tbl.getValueAt(rowIndex, 0)+"'");
                if(rs.next()){
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
        ...
        if(pname.getText().isEmpty() || pprice.getText().isEmpty()){
            ...
            dbc.insertData("INSERT INTO tbl_promos(p_name, p_price, p_status) VALUES('" + pname.getText() + "','" + pprice.getText() + "','" + pstat.getSelectedItem() + "')");
...
JOptionPane.showMessageDialog(null, "Please Choose first");
    ...
    if(pname.getText().isEmpty() || pprice.getText().isEmpty()){
      ...
      dbConnector dbc = new dbConnector();
            dbc.updateData("UPDATE tbl_promos SET p_name= '"+pname.getText()+"',p_price= '"+pprice.getText()+"',"
